...
function displayTelegramUserInfo() {
    ...
    if (user) {
        ...
        // profilePhotoEl.textContent = 'ФОТО'; // Эту строку удаляем или комментируем
        // Если вы хотите динамически менять src изображения через JS:
        // profilePhotoEl.querySelector('#user-profile-image').src = user.photo_url || '1l.webp';
    } else {
        usernameDisplayEl.textContent = 'Пользователь';
        // profilePhotoEl.textContent = 'ФОТО'; // И эту
    }
